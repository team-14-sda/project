**Federico Sciascia's journal (s333188)**

| Week (mm/dd - mm/dd) | Activity | Description |
|-------------------|----------|-------------|
|05/04 - 05/10|Meetings|Discussed on the work to accomplish, take responsibility over the design patterns discovery; alligned the other members with the work done|
|05/04 - 05/10|Research|Tried different tools, accomplished the generation UML diagram for the entire codebase with Doxygen (successfully)|
|05/04 - 05/10|Analysis|Looked into actual design patterns, choosed the starting point looking at dense enough trees  |
|05/04 - 05/10|Documentation|Creation of a brief report with the selected DP |
